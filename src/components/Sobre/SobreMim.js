                ...
                <Row className="align-items-center">
                    <Col>
                        <h1>{`José Lopes Sobrinho Neto`}<span className="wrap"></span></h1>
                         <p>Durante Curioso desde pequeno por jogos eletrônicos tecnologias e hardwares, agora Graduado em Ciências da Computação, Durante o curso me descobri como desenvolvedor web desenvolvendo desde pequenos sites do tipo landing pages, até Sistemas de contabilidade com Spring no backend.</p>
